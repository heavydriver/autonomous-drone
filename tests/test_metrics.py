    ...
    def test_logger_writes_frame_detection_and_track_rows(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            logger.log_frame(
                ...
                vehicle_state=None,
                pose_sampled=True,
                pose_right_hand_up=True,
                pose_reason="right hand raised",
                orbit_active=True,
                orbit_progress_deg=45.0,
                orbit_reason="orbit active",
            ...
            logger.log_frame(
                ...
                pose_reason="pose idle",
                orbit_active=False,
                orbit_progress_deg=360.0,
                orbit_reason="orbit complete",
                timings=TimingSnapshot(
                    frame_grab_latency_s=0.01,
                    detection_latency_s=0.02,
                    tracking_latency_s=0.01,
